            ...
            <div class="appointment-card">
                <div class="appointment-row">
                    ...
                    <div class="info">
                        ...
                        <div class="info-value">{{ $appointment->hospital->name ?? $appointment->preferred_location ?? 'BookEase Partner' }}</div>
                    </div>
                </div>
                ...
                <div class="appointment-row">
                    ...
                    <div class="info">
                        ...
                        <div class="info-value">{{ $appointment->hospital->address ?? $appointment->location_address ?? 'Address will be sent separately' }}</div>
                    </div>
                </div>
                ...
                <div class="appointment-row">
                    ...
                    <div class="info">
                        ...
                        <div class="info-value">{{ $appointment->appointment_date->format('l, F j, Y') }} at {{ $appointment->appointment_date->format('g:i A') }}</div>
                    </div>
                </div>
                ...
                <div class="appointment-row">
                    ...
                    <div class="info">
                        ...
                        <div class="info-value">{{ $appointment->service->name }} ({{ $appointment->service->duration_minutes }} min)</div>
                    </div>
                </div>
                ...
                <div class="appointment-row">
                    ...
                    <div class="info">
                        ...
                        <div class="info-value">${{ number_format($appointment->service->price, 2) }}</div>
                    </div>
                </div>
                @endif
            </div>
